  ...
  return (
    ...
    <div className="main text-2xl float-end pt-60 p-32">
      ...
      <div className="cont1 pb-11 w-9/12">
        ...
        <h3 className=' text-3xl font-normal capitalize py-9'>The Focus of Our Efforts</h3>
        <p className='text-2xl leading-10 '>Furthering our cause is the most important goal of our organization. We seek to support, empower, and provide high quality resources to communities impacted by climate change. Our success isn't measured in terms of wealth or profit margin, but by the value we provide to those we serve. Learn more about what we do below.</p>
