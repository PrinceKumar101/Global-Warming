    ...
    <>
      <div className="cont1 z-2 pt-4 relative flex">
        <div className="image1 relative ">
          <img
            className=" z-3 brightness-50 relative"
        ...
        <div className="hero_des absolute bottom-5 text-xl w-64 right-20">
          <p>
            Global Warming is dedicated to raising awareness about the impact of
            climate change on our planet. Our initiatives and activities are
            designed to catalyze true transformation. But above all, passion is
            at the heart and soul of everything that we do.
          </p>
        </div>
      </div>
    </>
