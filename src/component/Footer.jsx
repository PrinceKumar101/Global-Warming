...
const Footer = () => {
  return (
    <>
    <div className="cont1 flex justify-between border-t-2 pt-7 px-9 m-2">

        <div className="cont12 text-7xl pl-20 capitalize font-bold tracking-widest  leading-relaxed">
            <h2>
                global <br />warming
            </h2>
        ...
        <div className="cont13 grid text-xl px-10">
            ...
            <div className="form  ">
                ...
                <button className=' block  text-2xl border-[1.5px] p-1 rounded-lg'> Join  Now</button>
                </div>
            </div>
