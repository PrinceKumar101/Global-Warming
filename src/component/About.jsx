    ...
    const data=[
        {
            ...
            after_underline:"At Global Warming, we are committed to making a positive change in our world. From the moment we started our work in 2000, we understood that by working together we could overcome our challenges much more efficiently, and that is why we ultimately decided to launch Global Warming. Our strength lies not only in the words we stand by, but most importantly in the actions of our initiatives. We strive to make a positive change in all of our pursuits."
        }
    ]
  return (
    <>
